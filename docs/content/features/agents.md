...
LocalAI includes a built-in agent platform powered by [LocalAGI](https://github.com/l0caldadmin/LocalAGI). Agents are autonomous AI entities that can reason, use tools, maintain memory, and interact with external services — all running locally as part of the LocalAI process.
